                            ...
                            <div className='my-5 w-100 col-12'>
                                ...
                                <div className='input-text mt-3'>
                                    <div className='d-flex justify-content-between align-items-center w-100 '>
                                        ...
                                        <div>
                                            <p className='fs-7 fw-600 capitalize mb-1 pointer text-pink heading-font'> <Link to="/forget">Forget Password ?</Link></p>
                                        </div>
                                    </div>
                                ...
                                <div className='mt-5 text-start'>
                                    <p className='fs-6 fw-600 capitalize text-light mb-1 heading-font'>You Don't Have An  Acoount ? <span className='text-pink pointer'>
