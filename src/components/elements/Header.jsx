...
export default function Header() {
  ...
  return (
    <>
      <Navbar bg="transperent" className="py-lg-3 py-2  fixed-top my-nav-bg" expand="lg">
        <Container >
          <Navbar.Brand>
            <Link to="/">
              <h2 class="  text-pink heading-font capitalize fw-bold">Whales <span class="text-color"> Alerts</span></h2>
